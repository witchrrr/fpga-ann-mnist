...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/pratyush/Downloads/zed_board/FPGA_Handwritten/Vivado_projects/Pynq_handwritten_digit_recognition/Pynq_handwritten_digit_recognition.cache/compile_simlib/riviera"
  fi
  if [[ ($lib_map_path != "") ]]; then
