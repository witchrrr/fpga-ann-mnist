...
#
# Script generated by Vivado on Tue Dec 09 23:46:29 +0530 2025
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_49ec.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
