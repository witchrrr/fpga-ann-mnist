...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/pratyush/Downloads/zed_board/FPGA_Handwritten/Vivado_projects/Pynq_handwritten_digit_recognition/Pynq_handwritten_digit_recognition.cache/compile_simlib/questa"
  fi
