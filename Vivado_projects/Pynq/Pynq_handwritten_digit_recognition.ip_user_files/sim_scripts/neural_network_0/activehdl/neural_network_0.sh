...
#                script (type 'neural_network_0.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/zed_board/F/Vivado_projects/Pynq/Pynq_handwritten_digit_recognition.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
