...
#
# Script generated by Vivado on Fri Feb 20 21:34:49 +0530 2026
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : neural_network_0.sh
...
#
# Usage        : neural_network_0.sh
#                neural_network_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                neural_network_0.sh [-reset_run]
#                neural_network_0.sh [-reset_log]
#                neural_network_0.sh [-help]
#
...
export RDI_DATADIR="G:/xillinx/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L smartconnect_v1_0 -L xilinx_vip"

# script info
echo -e "neural_network_0.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./neural_network_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot neural_network_0 xil_defaultlib.neural_network_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim neural_network_0 -key {Behavioral:sim_1:Functional:neural_network_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_49ec.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="G:/xillinx/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb neural_network_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./neural_network_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: neural_network_0.sh [-help]\n\
Usage: neural_network_0.sh [-step]\n\
Usage: neural_network_0.sh [-lib_map_path]\n\
Usage: neural_network_0.sh [-reset_run]\n\
Usage: neural_network_0.sh [-reset_log]\n\
Usage: neural_network_0.sh [-keep_index]\n\
Usage: neural_network_0.sh [-noclean_files]\n\n\
