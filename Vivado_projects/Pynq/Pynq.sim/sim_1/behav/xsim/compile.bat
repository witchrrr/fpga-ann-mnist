...
REM
REM Generated by Vivado on Mon May 11 13:10:47 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj dense1_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj dense1_tb_vlog.prj -log xvlog.log
